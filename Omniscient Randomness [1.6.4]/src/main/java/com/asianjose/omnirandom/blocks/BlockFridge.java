...
public class BlockFridge extends BlockOmniContainer{
...
/*
	...
	*/
	...
	public void registerIcons(IconRegister reg){
		...
		this.blockIcon = reg.registerIcon("omnirandom:fridge");
	}
	...
	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ){
		if(!world.isRemote){
			FMLNetworkHandler.openGui(player, OmniscientRandomness.instance, OmniscientRandomness.guiIdFridge, world, x, y, z);
		}
		return true;
	}
	...
	public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase entity, ItemStack itemstack){
		...
		if(itemstack.hasDisplayName()) ((TileEntityFridge)world.getBlockTileEntity(x, y, z)).setGuiDisplayName(itemstack.getDisplayName());
	}
	
	public void breakBlock(World world, int x, int y, int z, int oldBlockID, int oldMetadata){
		TileEntityFridge tileentity = (TileEntityFridge) world.getBlockTileEntity(x, y, z);
	...
	public TileEntity createNewTileEntity(World world) {
		return new TileEntityFridge(); // Change to tileEntityFridge
	}
