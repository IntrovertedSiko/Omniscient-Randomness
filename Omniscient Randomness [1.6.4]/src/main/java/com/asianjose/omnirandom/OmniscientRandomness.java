...
public class OmniscientRandomness {
	...
	public void init(FMLInitializationEvent event){
		...
		// Crafting recipes!!!
		//GameRegistry.addShapedRecipe(new ItemStack(fridge), "xyx","yiy", "xyx", 'x', Item.redstone, 'y', Block.ice, 'i', Block.blockIron);
		//GameRegistry.addShapedRecipe(new ItemStack(fridge), "yxy", "xix", "yxy", 'x', Item.redstone, 'y', Block.ice, 'i', Block.blockIron);
		GameRegistry.addShapedRecipe(new ItemStack(xpDecomposer), "yxy", "ziz", "yxy", 'x', Item.diamond, 'y', Item.ghastTear, 'z', Block.dispenser, 'i', Block.blockIron);
		GameRegistry.addShapedRecipe(new ItemStack(xpDecomposer), "yzy", "xix", "yzy", 'x', Item.diamond, 'y', Item.ghastTear, 'z', Block.dispenser, 'i', Block.blockIron);
		GameRegistry.addShapedRecipe(new ItemStack(indComposter), "xyx", "ziz", "xyx", 'x', Block.cobblestoneMossy, 'y', Item.netherQuartz, 'z', Block.dirt, 'i', Block.blockIron);
		GameRegistry.addShapedRecipe(new ItemStack(indComposter), "xzx", "yiy", "xzx", 'x', Block.cobblestoneMossy, 'y', Item.netherQuartz, 'z', Block.dirt, 'i', Block.blockIron);
